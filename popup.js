...
chrome.tabs.query({ active: true, currentWindow: true }, (tabs) => {
    ...
    */
    ...
    if (document.body.classList.contains('dark-mode')) {
        modeImage.src = 'light.png'; // Obrazek dla ciemnego motywu
    } 
    else {
        modeImage.src = 'dark.png'; // Obrazek dla jasnego motywu
    }
    });
    ...
    if (currentLanguage == 'pl') {
        changeLanguage.src = 'pl.png'; // zmiana na angielski i wyświetla się możliwy polski
        ...
        changeLanguage.src = 'en.png'; // zmiana na polski i  wyświetla się możliwy ang
